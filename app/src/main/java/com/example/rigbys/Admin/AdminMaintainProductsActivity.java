...
public class AdminMaintainProductsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productImage = findViewById(R.id.admin_product_maintain_image);
        productName = findViewById(R.id.admin_product_maintain_name);
        productDescription = findViewById(R.id.admin_product_maintain_description);
        productPrice = findViewById(R.id.admin_product_maintain_price);
        applyChangesButton = findViewById(R.id.apply_changes_button);
        deleteProductButton = findViewById(R.id.admin_product_maintain_delete_button);
